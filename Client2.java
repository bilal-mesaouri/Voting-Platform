...
public class Client2 extends UnicastRemoteObject implements ClientInterf {
    public String numero;
    public String motDePasse;

    public Client2(String n, String mdp) throws RemoteException {
        numero = n;
        motDePasse = mdp;
    }
